...
`
  ...
  {
    id: 11,
    titleEn: "Acid-Base Balance & pH Regulation",
    titleHi: "अम्ल-क्षार संतुलन और pH नियमन",
    contentEn: `
# ⚖️ Acid-Base Balance & pH Regulation
...
|:-------|:-----------|:---------|
| **Bicarbonate** | HCO3-/H2CO3 | Blood, ECF |
| **Phosphate** | HPO4--/H2PO4- | ICF, kidneys |
| **Protein** | Hemoglobin, albumin | Blood, cells |
...
- Normal ratio: HCO3-:H2CO3 = 20:1
- This ratio maintains pH at 7.4
:::
...
|:-------|:---------|:-------|
| ↑ H+ (acidosis) | ↑ Breathing rate | ↓ CO2 → ↓ H+ |
| ↓ H+ (alkalosis) | ↓ Breathing rate | ↑ CO2 → ↑ H+ |

### 3. Renal Regulation (Hours to Days)

| Change | Kidney Response |
|:-------|:----------------|
| **Acidosis** | Excrete H+, reabsorb HCO3- |
...
| Cause | Examples |
|:------|:---------|
| Hypoventilation | COPD, asthma, pneumonia |
| CNS depression | Drugs, head injury |
| Airway obstruction | Foreign body, tumor |

**ABG Pattern:** pH ↓, pCO2 ↑, HCO3 normal/↑
...
### Metabolic Acidosis (HCO3 loss/H+ gain)
...
**ABG Pattern:** pH ↓, pCO2 normal/↓, HCO3 ↓

### Metabolic Alkalosis (HCO3 gain/H+ loss)

| Cause | Examples |
|:------|:---------|
| Vomiting | Loss of gastric acid |
| Diuretics | K+ and H+ loss |
| Antacids | Excess base intake |
...
2. Check pCO2 (respiratory cause?)
3. Check HCO3 (metabolic cause?)
...
2. Bicarbonate buffer: Most important in blood
3. 20:1 ratio (HCO3:H2CO3) maintains pH 7.4
4. Respiratory: Fast (minutes), controls CO2
5. Renal: Slow (hours-days), controls HCO3
6. ↓ pH + ↑ CO2 = Respiratory acidosis
7. ↓ pH + ↓ HCO3 = Metabolic acidosis
8. ↑ pH + ↓ CO2 = Respiratory alkalosis
9. ↑ pH + ↑ HCO3 = Metabolic alkalosis
:::
`,
    contentHi: `
# ⚖️ अम्ल-क्षार संतुलन और pH नियमन

## 📖 अवलोकन

:::info
**pH = हाइड्रोजन आयन सांद्रता का माप**

- सामान्य रक्त pH: **7.35 - 7.45**
- pH < 7.35 = एसिडोसिस (बहुत अम्लीय)
- pH > 7.45 = एल्कलोसिस (बहुत क्षारीय)
- जीवन-संगत सीमा: 6.8 - 7.8
:::
...
## 🛡️ रक्षा की तीन पंक्तियां

### 1. बफर प्रणाली (तत्काल - सेकंड)

| बफर | घटक | स्थान |
|:----|:-----|:------|
| **बाइकार्बोनेट** | HCO3-/H2CO3 | रक्त, ECF |
| **फॉस्फेट** | HPO4--/H2PO4- | ICF, गुर्दे |
| **प्रोटीन** | हीमोग्लोबिन, एल्बुमिन | रक्त, कोशिकाएं |

### बाइकार्बोनेट बफर (सबसे महत्वपूर्ण)

:::success
**समीकरण:**
CO2 + H2O ⇌ H2CO3 ⇌ H+ + HCO3-

- सामान्य अनुपात: HCO3-:H2CO3 = 20:1
- यह अनुपात pH को 7.4 पर बनाए रखता है
:::

### 2. श्वसन नियमन (मिनट)

| परिवर्तन | प्रतिक्रिया | परिणाम |
|:--------|:----------|:-------|
| ↑ H+ (एसिडोसिस) | ↑ श्वसन दर | ↓ CO2 → ↓ H+ |
| ↓ H+ (एल्कलोसिस) | ↓ श्वसन दर | ↑ CO2 → ↑ H+ |

### 3. वृक्क नियमन (घंटों से दिन)

| परिवर्तन | गुर्दे प्रतिक्रिया |
|:--------|:-----------------|
| **एसिडोसिस** | H+ उत्सर्जन, HCO3- पुनर्अवशोषण |
| **एल्कलोसिस** | H+ प्रतिधारण, HCO3- उत्सर्जन |

---

## ⚠️ अम्ल-क्षार विकार

### श्वसन एसिडोसिस (CO2 प्रतिधारण)

| कारण | उदाहरण |
|:-----|:-------|
| हाइपोवेंटिलेशन | COPD, अस्थमा, निमोनिया |
| CNS अवसाद | दवाएं, सिर की चोट |
| वायुमार्ग अवरोध | विदेशी पदार्थ, ट्यूमर |

**ABG पैटर्न:** pH ↓, pCO2 ↑, HCO3 सामान्य/↑

### श्वसन एल्कलोसिस (CO2 हानि)

| कारण | उदाहरण |
|:-----|:-------|
| हाइपरवेंटिलेशन | चिंता, दर्द, बुखार |
| हाइपोक्सिया | ऊंचाई |
| यांत्रिक | वेंटिलेटर सेटिंग्स |

**ABG पैटर्न:** pH ↑, pCO2 ↓, HCO3 सामान्य/↓

### चयापचय एसिडोसिस (HCO3 हानि/H+ वृद्धि)

| कारण | उदाहरण |
|:-----|:-------|
| कीटोएसिडोसिस | मधुमेह, भुखमरी |
| लैक्टिक एसिडोसिस | शॉक, हाइपोक्सिया |
| गुर्दे की विफलता | ↓ H+ उत्सर्जन |
| दस्त | HCO3 हानि |

**ABG पैटर्न:** pH ↓, pCO2 सामान्य/↓, HCO3 ↓

### चयापचय एल्कलोसिस (HCO3 वृद्धि/H+ हानि)

| कारण | उदाहरण |
|:-----|:-------|
| उल्टी | जठर अम्ल हानि |
| मूत्रवर्धक | K+ और H+ हानि |
| एंटासिड | अधिक क्षार सेवन |

**ABG पैटर्न:** pH ↑, pCO2 सामान्य/↑, HCO3 ↑

---

## 🔬 धमनी रक्त गैस (ABG) मान
...
:::tip
**याद रखें:**
1. सामान्य रक्त pH: 7.35-7.45
2. बाइकार्बोनेट बफर: रक्त में सबसे महत्वपूर्ण
3. 20:1 अनुपात (HCO3:H2CO3) pH 7.4 बनाए रखता है
4. श्वसन: तेज (मिनट), CO2 नियंत्रित
5. वृक्क: धीमा (घंटे-दिन), HCO3 नियंत्रित
6. ↓ pH + ↑ CO2 = श्वसन एसिडोसिस
7. ↓ pH + ↓ HCO3 = चयापचय एसिडोसिस
:::
`
  },
  {
    id: 12,
    titleEn: "Fluid & Electrolyte Balance",
    titleHi: "द्रव और इलेक्ट्रोलाइट संतुलन",
    contentEn: `
...
- ~50% in females (more fat, less water)
- ~70% in infants
:::
...
| Compartment | % Body Weight | Location |
|:------------|:--------------|:---------|
| **ICF** (Intracellular) | 40% | Inside cells |
| **ECF** (Extracellular) | 20% | Outside cells |

### ECF Subdivisions

| Type | % Body Weight | Examples |
|:-----|:--------------|:---------|
| **Plasma** | 4-5% | Blood vessels |
| **Interstitial** | 15% | Between cells |
| **Transcellular** | 1-3% | CSF, synovial, GI |
...
| Electrolyte | ECF Normal | Function |
|:------------|:-----------|:---------|
| **Sodium (Na+)** | 135-145 mEq/L | Water balance, nerve/muscle |
| **Potassium (K+)** | 3.5-5.0 mEq/L | Muscle contraction, heart rhythm |
| **Calcium (Ca++)** | 8.5-10.5 mg/dL | Bone, muscle, clotting |
| **Magnesium (Mg++)** | 1.5-2.5 mEq/L | Enzyme function |
...
| **Bicarbonate (HCO3-)** | 22-26 mEq/L | Buffer system |
| **Phosphate** | 2.5-4.5 mg/dL | Bone, energy |
...
| Cause | Examples |
|:------|:---------|
| Dilution | Excess water intake, SIADH |
| Loss | Vomiting, diarrhea, diuretics |
...
| Na+ excess | IV saline, salt poisoning |

**Symptoms:** Thirst, restlessness, confusion, seizures
...
|:------|:---------|
| Loss | Vomiting, diarrhea, diuretics |
| Shift into cells | Insulin, alkalosis |

**Symptoms:** Weakness, cramps, arrhythmias, paralysis
...
| Cause | Examples |
|:------|:---------|
| Decreased excretion | Renal failure, ACE inhibitors |
| Shift out of cells | Acidosis, tissue damage |
| Excess intake | IV potassium, blood transfusion |

**Symptoms:** Weakness, paresthesia, arrhythmias
...
## 🦴 Calcium (Ca++) Disorders

### Hypocalcemia (Ca < 8.5)

| Cause | Examples |
|:------|:---------|
| ↓ PTH | Parathyroid surgery |
| Vitamin D deficiency | Poor intake, malabsorption |

**Symptoms:** Tetany, numbness, Chvostek/Trousseau signs
...
**Symptoms:** "Stones, bones, groans, moans" (kidney stones, bone pain, GI, psychiatric)
...
|:-----|:---------|:-------|
| Thirst | Dry mouth | Hypotension |
| ↓ Urine | ↑ Heart rate | Sunken eyes |
| | Poor skin turgor | Altered mental status |
...
| Type | Examples | Use |
|:-----|:---------|:----|
| **Isotonic** | NS (0.9% NaCl), RL | Volume replacement |
| **Hypotonic** | 0.45% NaCl | Cellular dehydration |
| **Hypertonic** | 3% NaCl | Severe hyponatremia |
| **Colloids** | Albumin, dextran | Plasma expansion |
...
:::tip
**Remember:**
1. Body water: 60% male, 50% female, 70% infant
2. ICF = 40%, ECF = 20% of body weight
3. Na+ = Main ECF cation (135-145)
4. K+ = Main ICF cation (3.5-5.0)
5. Hypokalemia: Flat T, U waves
6. Hyperkalemia: Peaked T waves - dangerous!
7. Hypocalcemia: Chvostek, Trousseau signs
8. Hypercalcemia: "Stones, bones, groans, moans"
9. Daily fluid balance ~2500 mL in = out
:::
`,
    contentHi: `
...
:::info
**शरीर जल:**
- वयस्क पुरुषों में शरीर के वजन का ~60%
- महिलाओं में ~50% (अधिक वसा, कम पानी)
- शिशुओं में ~70%
:::

---

## 💦 शरीर द्रव कम्पार्टमेंट

### कुल शरीर जल वितरण

| कम्पार्टमेंट | शरीर वजन % | स्थान |
|:------------|:----------|:------|
| **ICF** (अंतःकोशिकीय) | 40% | कोशिकाओं के अंदर |
| **ECF** (बाह्यकोशिकीय) | 20% | कोशिकाओं के बाहर |

### ECF उपविभाजन

| प्रकार | शरीर वजन % | उदाहरण |
|:-------|:----------|:-------|
| **प्लाज्मा** | 4-5% | रक्त वाहिकाएं |
| **अंतरालीय** | 15% | कोशिकाओं के बीच |
| **ट्रांससेलुलर** | 1-3% | CSF, साइनोवियल |

---

## ⚡ प्रमुख इलेक्ट्रोलाइट्स

### धनायन (धनात्मक आयन)

| इलेक्ट्रोलाइट | ECF सामान्य | कार्य |
|:-------------|:----------|:------|
| **सोडियम (Na+)** | 135-145 mEq/L | जल संतुलन, तंत्रिका/मांसपेशी |
| **पोटेशियम (K+)** | 3.5-5.0 mEq/L | मांसपेशी संकुचन, हृदय लय |
| **कैल्शियम (Ca++)** | 8.5-10.5 mg/dL | हड्डी, मांसपेशी, थक्का |
| **मैग्नीशियम (Mg++)** | 1.5-2.5 mEq/L | एंजाइम कार्य |

### ऋणायन (ऋणात्मक आयन)

| इलेक्ट्रोलाइट | ECF सामान्य | कार्य |
|:-------------|:----------|:------|
| **क्लोराइड (Cl-)** | 96-106 mEq/L | अम्ल-क्षार संतुलन |
| **बाइकार्बोनेट (HCO3-)** | 22-26 mEq/L | बफर प्रणाली |

---

## 🧂 सोडियम (Na+) विकार

### हाइपोनेट्रेमिया (Na+ < 135)

| कारण | उदाहरण |
|:-----|:-------|
| तनुकरण | अत्यधिक पानी सेवन, SIADH |
| हानि | उल्टी, दस्त, मूत्रवर्धक |

**लक्षण:** सिरदर्द, मतली, भ्रम, दौरे

### हाइपरनेट्रेमिया (Na+ > 145)

| कारण | उदाहरण |
|:-----|:-------|
| जल हानि | निर्जलीकरण, डायबिटीज इन्सिपिडस |
| Na+ अधिकता | IV सेलाइन, नमक विषाक्तता |

**लक्षण:** प्यास, बेचैनी, भ्रम, दौरे
...
|:-----|:-------|
| हानि | उल्टी, दस्त, मूत्रवर्धक |
| कोशिकाओं में शिफ्ट | इंसुलिन, एल्कलोसिस |

**लक्षण:** कमजोरी, ऐंठन, अतालता, पक्षाघात

:::danger
**हाइपोकैलेमिया में ECG परिवर्तन:**
- चपटी T तरंगें
- U तरंगें
- ST अवसाद
:::
...
| कारण | उदाहरण |
|:-----|:-------|
| कम उत्सर्जन | गुर्दे की विफलता |
| कोशिकाओं से बाहर शिफ्ट | एसिडोसिस, ऊतक क्षति |

**लक्षण:** कमजोरी, संवेदनहीनता, अतालता

:::danger
**हाइपरकैलेमिया में ECG परिवर्तन:**
- लंबी नुकीली T तरंगें
- चौड़ा QRS
- **हृदय गति रुकने का जोखिम!**
:::
...
### हाइपोकैल्सीमिया (Ca < 8.5)

| कारण | उदाहरण |
|:-----|:-------|
| ↓ PTH | पैराथायरॉइड सर्जरी |
| विटामिन D की कमी | कम सेवन, कुअवशोषण |

**लक्षण:** टेटनी, सुन्नपन, Chvostek/Trousseau संकेत

### हाइपरकैल्सीमिया (Ca > 10.5)

| कारण | उदाहरण |
|:-----|:-------|
| ↑ PTH | हाइपरपैराथायरॉइडिज्म |
| दुर्दमता | हड्डी मेटास्टेसिस |

**लक्षण:** "पथरी, हड्डी, पेट दर्द, मानसिक"

---

## 💧 जल संतुलन

### दैनिक जल सेवन और निर्गम

| सेवन (mL) | निर्गम (mL) |
|:----------|:----------|
| पेय: 1500 | मूत्र: 1500 |
| भोजन: 700 | त्वचा: 500 |
| चयापचय: 300 | फेफड़े: 400 |
| | मल: 100 |
| **कुल: 2500** | **कुल: 2500** |
...
| हल्का | मध्यम | गंभीर |
|:------|:------|:------|
| प्यास | सूखा मुंह | निम्न रक्तचाप |
| ↓ मूत्र | ↑ हृदय गति | धंसी आंखें |
| | खराब त्वचा टर्गर | बदली चेतना |
...
| प्रकार | उदाहरण | उपयोग |
|:-------|:-------|:------|
| **आइसोटोनिक** | NS (0.9% NaCl), RL | मात्रा प्रतिस्थापन |
| **हाइपोटोनिक** | 0.45% NaCl | कोशिकीय निर्जलीकरण |
| **हाइपरटोनिक** | 3% NaCl | गंभीर हाइपोनेट्रेमिया |
| **कोलॉइड्स** | एल्बुमिन | प्लाज्मा विस्तार |
...
:::tip
**याद रखें:**
1. शरीर जल: 60% पुरुष, 50% महिला, 70% शिशु
2. ICF = 40%, ECF = 20% शरीर वजन
3. Na+ = मुख्य ECF धनायन (135-145)
4. K+ = मुख्य ICF धनायन (3.5-5.0)
5. हाइपोकैलेमिया: चपटी T, U तरंगें
6. हाइपरकैलेमिया: नुकीली T तरंगें - खतरनाक!
7. हाइपोकैल्सीमिया: Chvostek, Trousseau संकेत
8. दैनिक द्रव संतुलन ~2500 mL अंदर = बाहर
:::
`
  }
];
