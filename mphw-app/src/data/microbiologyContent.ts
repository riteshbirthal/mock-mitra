...
`
  ...
  {
    id: 11,
    titleEn: "Antimicrobial Resistance (AMR)",
    titleHi: "रोगाणुरोधी प्रतिरोध (AMR)",
    contentEn: `
...
:::danger
**AMR = Ability of microorganisms to resist antimicrobial drugs**
...
| Cause | Mechanism |
|:------|:----------|
| **Overuse** | Unnecessary antibiotic prescriptions |
| **Misuse** | Incomplete courses, wrong drug |
| **Agriculture** | Antibiotics in animal feed |
| **Poor infection control** | Spread of resistant strains |
| **Lack of new drugs** | Limited new antibiotic development |
...
| **Acquired** | Developed through mutation |
| **Transferable** | Passed between bacteria (plasmids) |

### Mechanisms of Resistance

| Mechanism | Example |
|:----------|:--------|
| **Drug inactivation** | Beta-lactamase destroys penicillin |
| **Target modification** | Altered binding site |
| **Efflux pumps** | Pump out the drug |
| **Reduced permeability** | Drug cannot enter |

---

## 🏥 Important Resistant Organisms

| Organism | Resistance | Clinical Concern |
|:---------|:-----------|:-----------------|
| **MRSA** | Methicillin | Skin, blood, pneumonia |
| **VRE** | Vancomycin | UTI, bacteremia |
| **ESBL** | Extended-spectrum | UTI, sepsis |
| **CRE** | Carbapenems | Very limited treatment |
| **MDR-TB** | Multiple drugs | Difficult to treat |
| **XDR-TB** | Extensively drug-resistant | Almost untreatable |
...
| Action | Description |
|:-------|:------------|
| Prescribe wisely | Only when necessary |
| Right drug/dose/duration | Follow guidelines |
| Culture before treatment | When possible |
| Infection prevention | Hand hygiene, isolation |
| Educate patients | Complete course |

### For Patients

| Do | Don't |
|:---|:------|
| Complete full course | Skip doses |
| Take as prescribed | Share antibiotics |
| Report side effects | Save for later |
| Practice hygiene | Self-medicate |
...
### National Programme
- **NCDC** coordinates AMR surveillance
- **ICMR** AMR network
...
:::tip
**Remember:**
1. AMR = Microbes resist drugs
2. Causes: Overuse, misuse, agriculture
3. MRSA, VRE, CRE = Major concerns
4. MDR-TB, XDR-TB = TB resistance forms
5. Prevention: Appropriate use, complete course
6. NCDC, ICMR lead surveillance
7. Red Line = Prescription-only antibiotics
:::
`,
    contentHi: `
...
:::danger
**AMR = सूक्ष्मजीवों की रोगाणुरोधी दवाओं का विरोध करने की क्षमता**

- एक प्रमुख वैश्विक स्वास्थ्य खतरा
- संक्रमण का इलाज कठिन बनाता है
- मृत्यु दर, रुग्णता और लागत बढ़ाता है
:::
...
| कारण | तंत्र |
|:-----|:------|
| **अत्यधिक उपयोग** | अनावश्यक एंटीबायोटिक नुस्खे |
| **दुरुपयोग** | अधूरे कोर्स, गलत दवा |
| **कृषि** | पशु चारे में एंटीबायोटिक्स |
| **खराब संक्रमण नियंत्रण** | प्रतिरोधी स्ट्रेन का प्रसार |
...
| प्रकार | विवरण |
|:-------|:------|
| **आंतरिक** | प्राकृतिक प्रतिरोध |
| **अर्जित** | म्यूटेशन द्वारा विकसित |
| **हस्तांतरणीय** | बैक्टीरिया के बीच पारित (प्लाज्मिड) |

---

## 🏥 महत्वपूर्ण प्रतिरोधी जीव

| जीव | प्रतिरोध | नैदानिक चिंता |
|:----|:--------|:-------------|
| **MRSA** | मेथिसिलिन | त्वचा, रक्त, निमोनिया |
| **VRE** | वैनकोमाइसिन | UTI, बैक्टीरेमिया |
| **CRE** | कार्बापेनेम | बहुत सीमित उपचार |
| **MDR-TB** | बहु दवा | इलाज कठिन |
| **XDR-TB** | व्यापक दवा-प्रतिरोधी | लगभग अनुपचार्य |

---

## 🛡️ AMR की रोकथाम

### स्वास्थ्य कार्यकर्ताओं के लिए

| कार्रवाई | विवरण |
|:--------|:------|
| बुद्धिमानी से नुस्खा | केवल जब आवश्यक हो |
| सही दवा/खुराक/अवधि | दिशानिर्देशों का पालन |
| उपचार से पहले कल्चर | जब संभव हो |
| संक्रमण रोकथाम | हाथ स्वच्छता, अलगाव |

### रोगियों के लिए

| करें | न करें |
|:----|:-------|
| पूरा कोर्स लें | खुराक छोड़ें |
| निर्देशानुसार लें | एंटीबायोटिक्स साझा करें |
| स्वच्छता का अभ्यास | स्व-दवा |

---

## 📊 भारत में AMR निगरानी

### राष्ट्रीय कार्यक्रम
- **NCDC** AMR निगरानी का समन्वय
- **ICMR** AMR नेटवर्क
- प्रयोगशाला-आधारित निगरानी

### प्रमुख पहल
- AMR पर राष्ट्रीय कार्य योजना (2017-2021)
- AMR पर दिल्ली घोषणा
- रेड लाइन अभियान
...
:::tip
**याद रखें:**
1. AMR = सूक्ष्मजीव दवाओं का विरोध
2. कारण: अत्यधिक उपयोग, दुरुपयोग, कृषि
3. MRSA, VRE, CRE = प्रमुख चिंताएं
4. MDR-TB, XDR-TB = TB प्रतिरोध रूप
5. रोकथाम: उचित उपयोग, पूरा कोर्स
6. NCDC, ICMR निगरानी का नेतृत्व
7. रेड लाइन = केवल नुस्खे पर एंटीबायोटिक्स
:::
`
  },
  {
    id: 12,
    titleEn: "Laboratory Diagnosis & Specimen Collection",
    titleHi: "प्रयोगशाला निदान और नमूना संग्रह",
    contentEn: `
...
:::info
**Laboratory diagnosis = Identification of infectious agents**
...
| Specimen | Tests | Container |
|:---------|:------|:----------|
| **Blood** | Culture, serology | Sterile vial |
| **Urine** | Culture, routine | Sterile container |
| **Stool** | Culture, parasites | Wide-mouth container |
| **Sputum** | AFB, culture | Sterile container |
| **Swabs** | Culture | Transport medium |
| **CSF** | Culture, routine | Sterile tube |
...
| 2 | Apply povidone-iodine, let dry |
| 3 | Clean with alcohol again |
| 4 | Collect 10-20 mL (adult) |
| 5 | Inject into culture bottle |

### Timing
- Best: During fever spike
...
| 4 | Do not touch inside container |

### Transport
- Refrigerate if delay >2 hours
- Best: Within 1 hour
...
### For Culture/Parasites

| Step | Action |
|:-----|:-------|
| 1 | Collect in clean, dry container |
| 2 | Avoid urine contamination |
| 3 | Include mucus/blood if present |
| 4 | Send within 2 hours |

### For Parasites
- Fresh, warm specimen best
- Three specimens on different days
- Examine within 30 min for motile forms

---

## 🫁 Sputum Collection

### For AFB (TB Diagnosis)

| Collection | Instructions |
|:-----------|:-------------|
| **Spot** | At first visit |
| **Early morning** | Deep cough after waking |
| **Spot** | At second visit |

### Quality
- Deep cough, not saliva
- Minimum 2 mL
- Mucopurulent preferred
...
| Test | Purpose |
|:-----|:--------|
| **Gram stain** | Bacteria classification |
| **ZN stain** | AFB (TB) |
| **Wet mount** | Parasites |
| **KOH** | Fungi |
...
2. Blood culture: 2 sets, different sites
3. Urine: Mid-stream clean catch
4. Sputum: Deep cough, early morning
5. Stool: Avoid urine contamination
6. Gram stain: Bacteria classification
7. ZN stain: AFB/TB
8. Transport specimens promptly
:::
`,
    contentHi: `
# 🔬 प्रयोगशाला निदान और नमूना संग्रह

## 📖 अवलोकन

:::info
**प्रयोगशाला निदान = संक्रामक एजेंटों की पहचान**

सटीक निदान के लिए उचित नमूना संग्रह महत्वपूर्ण है।
:::
...
| नमूना | परीक्षण | कंटेनर |
|:------|:-------|:-------|
| **रक्त** | कल्चर, सीरोलॉजी | स्टेराइल वायल |
| **मूत्र** | कल्चर, रूटीन | स्टेराइल कंटेनर |
| **मल** | कल्चर, परजीवी | चौड़े मुंह का कंटेनर |
| **थूक** | AFB, कल्चर | स्टेराइल कंटेनर |
| **स्वैब** | कल्चर | ट्रांसपोर्ट मीडियम |
...
| चरण | क्रिया |
|:----|:------|
| 1 | 70% अल्कोहल से साइट साफ करें |
| 2 | पोविडोन-आयोडीन लगाएं, सूखने दें |
| 3 | फिर से अल्कोहल से साफ करें |
| 4 | 10-20 mL (वयस्क) एकत्र करें |
| 5 | कल्चर बोतल में इंजेक्ट करें |

### समय
- सर्वोत्तम: बुखार स्पाइक के दौरान
- एंटीबायोटिक्स शुरू करने से पहले
- अलग-अलग साइटों से दो सेट

---

## 🧪 मूत्र संग्रह

### मिड-स्ट्रीम क्लीन कैच

| चरण | क्रिया |
|:----|:------|
| 1 | जननांग क्षेत्र साफ करें |
| 2 | पेशाब शुरू करें |
| 3 | मिड-स्ट्रीम एकत्र करें |
| 4 | कंटेनर के अंदर न छुएं |

### परिवहन
- 2 घंटे से अधिक देरी हो तो रेफ्रिजरेट करें
- सर्वोत्तम: 1 घंटे के भीतर
...
| चरण | क्रिया |
|:----|:------|
| 1 | स्वच्छ, सूखे कंटेनर में एकत्र करें |
| 2 | मूत्र संदूषण से बचें |
| 3 | यदि मौजूद हो तो बलगम/रक्त शामिल करें |
| 4 | 2 घंटे के भीतर भेजें |

### परजीवियों के लिए
- ताजा, गर्म नमूना सबसे अच्छा
- विभिन्न दिनों पर तीन नमूने
- गतिशील रूपों के लिए 30 मिनट के भीतर जांच
...
|:-------|:-------|
| **स्पॉट** | पहली विजिट पर |
| **सुबह जल्दी** | जागने के बाद गहरी खांसी |
| **स्पॉट** | दूसरी विजिट पर |

### गुणवत्ता
- गहरी खांसी, लार नहीं
- न्यूनतम 2 mL
- म्यूकोप्यूरुलेंट पसंदीदा
...
| परीक्षण | उद्देश्य |
|:-------|:--------|
| **ग्राम स्टेन** | बैक्टीरिया वर्गीकरण |
| **ZN स्टेन** | AFB (TB) |
| **वेट माउंट** | परजीवी |
| **KOH** | कवक |
...
| माध्यम | जीव |
|:-------|:----|
| **ब्लड अगार** | अधिकांश बैक्टीरिया |
| **मैककॉन्की** | ग्राम-नेगेटिव |
| **LJ माध्यम** | TB |
| **साबरो** | कवक |
...
:::tip
**याद रखें:**
1. एंटीबायोटिक्स शुरू करने से पहले एकत्र करें
2. रक्त कल्चर: 2 सेट, अलग साइट
3. मूत्र: मिड-स्ट्रीम क्लीन कैच
4. थूक: गहरी खांसी, सुबह जल्दी
5. मल: मूत्र संदूषण से बचें
6. ग्राम स्टेन: बैक्टीरिया वर्गीकरण
7. ZN स्टेन: AFB/TB
8. नमूने तुरंत भेजें
:::
`
