...
`
  ...
  {
    id: 11,
    titleEn: "NTDs: Neglected Tropical Diseases",
    titleHi: "NTDs: उपेक्षित उष्णकटिबंधीय रोग",
    contentEn: `
# 🌍 Neglected Tropical Diseases (NTDs)
...
:::info
**NTDs = Diseases affecting poorest populations**
- Cause disability, stigma, and economic loss
- India has high burden of several NTDs
...
### Prevention & Control
- **MDA** with Albendazole (400 mg single dose)
- Deworming Day: February 10 & August 10
...
- Causes elephantiasis, hydrocele

### Control Strategy
- **MDA**: DEC + Albendazole annually
- Triple drug (IDA) in some areas
- Morbidity management (lymphedema care)

---

## 🏜️ Kala-azar (Visceral Leishmaniasis)

### Key Points
- Caused by Leishmania donovani
- Vector: Sandfly
- Endemic in Bihar, Jharkhand, UP, WB

### Elimination Strategy
- Early diagnosis (rK39)
- Treatment (Liposomal Amphotericin B)
- IRS with DDT/synthetic pyrethroids
- PKDL treatment
...
### Key Points
- Caused by M. leprae
- Elimination achieved (<1/10,000)
- MDT: 6 months (PB), 12 months (MB)
- Focus on new case detection and disability prevention
...
- Prevention: PEP with ARV ± RIG
- Wound washing critical
...
:::tip
**Remember:**
1. STH: Roundworm, Whipworm, Hookworm
2. Deworming: Feb 10 & Aug 10 (Albendazole)
3. Filariasis: MDA with DEC + Albendazole
4. Kala-azar: rK39 diagnosis, AmBisome treatment
5. Leprosy: MDT 6/12 months
6. Rabies: PEP is life-saving
7. NTDs affect poorest populations
:::
`,
    contentHi: `
# 🌍 उपेक्षित उष्णकटिबंधीय रोग (NTDs)
...
:::info
**NTDs = सबसे गरीब आबादी को प्रभावित करने वाले रोग**
- विकलांगता, कलंक और आर्थिक नुकसान
- भारत में कई NTDs का उच्च बोझ
- कई रोकथाम योग्य और उपचार योग्य
:::

---

## 🪱 मृदा-संचारित हेल्मिन्थियासिस (STH)
...
|:------|:----------|
| **एस्केरिस** | गोल कीड़ा |
| **ट्राइक्यूरिस** | व्हिपवर्म |
| **हुकवर्म** | अंकुश कीड़ा |

### संचरण
- मल-मौखिक (एस्केरिस, ट्राइक्यूरिस)
- त्वचा प्रवेश (हुकवर्म)
...
### रोकथाम और नियंत्रण
- **MDA** एल्बेंडाजोल के साथ (400 mg एकल खुराक)
- कृमि मुक्ति दिवस: 10 फरवरी और 10 अगस्त
- लक्ष्य: 1-19 वर्ष के बच्चे
- WASH सुधार
...
### मुख्य बिंदु
- वुचेरेरिया बैनक्रॉफ्टी से होता है
- वेक्टर: क्यूलेक्स मच्छर
- एलिफेंटियासिस, हाइड्रोसील का कारण

### नियंत्रण रणनीति
- **MDA**: DEC + एल्बेंडाजोल वार्षिक
- कुछ क्षेत्रों में ट्रिपल ड्रग (IDA)
- रुग्णता प्रबंधन (लिम्फेडेमा देखभाल)
...
### मुख्य बिंदु
- लीशमैनिया डोनोवानी से होता है
- वेक्टर: सैंडफ्लाई
- बिहार, झारखंड, UP, WB में स्थानिक

### उन्मूलन रणनीति
- शीघ्र निदान (rK39)
- उपचार (लिपोसोमल एम्फोटेरिसिन B)
- IRS DDT/सिंथेटिक पाइरेथ्रोइड्स से
- PKDL उपचार
...
### मुख्य बिंदु
- M. leprae से होता है
- उन्मूलन प्राप्त (<1/10,000)
- MDT: 6 महीने (PB), 12 महीने (MB)
- नए केस खोज और विकलांगता रोकथाम पर फोकस
...
### मुख्य बिंदु
- लक्षण आने पर 100% घातक
- रोकथाम: ARV ± RIG के साथ PEP
- घाव धोना महत्वपूर्ण
- कुत्ता टीकाकरण कार्यक्रम
...
:::tip
**याद रखें:**
1. STH: गोल कीड़ा, व्हिपवर्म, हुकवर्म
2. कृमि मुक्ति: 10 फरवरी और 10 अगस्त (एल्बेंडाजोल)
3. फाइलेरिया: DEC + एल्बेंडाजोल के साथ MDA
4. काला-अजार: rK39 निदान, AmBisome उपचार
5. कुष्ठ: MDT 6/12 महीने
6. रेबीज: PEP जीवन रक्षक
7. NTDs सबसे गरीब आबादी को प्रभावित करते हैं
:::
`
  },
  {
    id: 12,
    titleEn: "Sexually Transmitted Infections (STIs)",
    titleHi: "यौन संचारित संक्रमण (STIs)",
    contentEn: `
...
:::info
**STIs = Infections spread through sexual contact**
- Major public health problem
- Can be bacterial, viral, or parasitic
- Many are curable, some controllable
:::
...
|:----|:----------------|:-------------|
| **Syphilis** | Treponema pallidum | Painless ulcer (chancre) |
| **Gonorrhea** | Neisseria gonorrhoeae | Purulent discharge |
| **Chlamydia** | Chlamydia trachomatis | Often asymptomatic |
| **Chancroid** | H. ducreyi | Painful ulcer |

### Viral (Controllable, not curable)

| STI | Virus | Key Features |
|:----|:------|:-------------|
| **HIV/AIDS** | HIV-1, HIV-2 | Immunodeficiency |
| **Herpes** | HSV-2 | Recurrent painful ulcers |
| **HPV** | Human Papillomavirus | Warts, cervical cancer |
| **Hepatitis B** | HBV | Liver disease |
...
### Approach
- Treat based on symptoms (syndromes)
- No waiting for lab results
- Cover common causes

### Key Syndromes

| Syndrome | Common Causes | Treatment |
|:---------|:--------------|:----------|
| **Urethral discharge** | Gonorrhea + Chlamydia | Ceftriaxone + Azithromycin |
| **Genital ulcer** | Syphilis + Chancroid + Herpes | Benzathine Penicillin + Azithromycin + Acyclovir |
| **Vaginal discharge** | Multiple | Based on assessment |
...
:::tip
**Remember:**
1. STIs: Bacterial (curable) vs Viral (controllable)
2. Syndromic management: Treat without waiting for labs
3. Urethral discharge: Ceftriaxone + Azithromycin
4. HIV: ART is lifelong, free under NACO
5. Prevention: ABC (Abstinence, Be faithful, Condoms)
6. ICTC for HIV testing and counseling
7. Confidentiality is critical
8. Partner notification important
:::
`,
    contentHi: `
...
:::info
**STIs = यौन संपर्क से फैलने वाले संक्रमण**
- प्रमुख सार्वजनिक स्वास्थ्य समस्या
- बैक्टीरियल, वायरल या परजीवी हो सकते हैं
- कई इलाज योग्य, कुछ नियंत्रणीय
:::
...
### बैक्टीरियल (इलाज योग्य)

| STI | कारक एजेंट | मुख्य विशेषताएं |
|:----|:----------|:-------------|
| **सिफलिस** | ट्रेपोनेमा पैलिडम | दर्दरहित अल्सर (चैंक्र) |
| **गोनोरिया** | निसेरिया गोनोरिया | पीप डिस्चार्ज |
| **क्लैमाइडिया** | क्लैमाइडिया ट्रैकोमैटिस | अक्सर लक्षणहीन |
| **शैंक्रॉइड** | H. ducreyi | दर्दनाक अल्सर |

### वायरल (नियंत्रणीय, इलाज नहीं)

| STI | वायरस | मुख्य विशेषताएं |
|:----|:------|:--------------|
| **HIV/AIDS** | HIV-1, HIV-2 | इम्युनोडेफिशिएंसी |
| **हर्पीस** | HSV-2 | बार-बार दर्दनाक अल्सर |
| **HPV** | ह्यूमन पैपिलोमावायरस | मस्से, सर्वाइकल कैंसर |
| **हेपेटाइटिस B** | HBV | लीवर रोग |
...
### दृष्टिकोण
- लक्षणों (सिंड्रोम) के आधार पर उपचार
- लैब परिणामों की प्रतीक्षा नहीं
- सामान्य कारणों को कवर करें

### मुख्य सिंड्रोम

| सिंड्रोम | सामान्य कारण | उपचार |
|:---------|:-----------|:------|
| **मूत्रमार्ग स्राव** | गोनोरिया + क्लैमाइडिया | सेफ्ट्रिएक्सोन + एज़िथ्रोमाइसिन |
| **जननांग अल्सर** | सिफलिस + शैंक्रॉइड + हर्पीस | बेंजाथिन पेनिसिलिन + एज़िथ्रोमाइसिन + एसाइक्लोविर |
| **योनि स्राव** | कई | मूल्यांकन के आधार पर |
...
### संचरण
- यौन (सबसे आम)
- रक्त (ट्रांसफ्यूजन, सुई)
- माता से बच्चे (वर्टिकल)

### रोकथाम
- सुरक्षित यौन व्यवहार (कंडोम)
- रक्त सुरक्षा
- PPTCT (माता से बच्चे में संचरण रोकथाम)
- PrEP और PEP

### परीक्षण
- रैपिड टेस्ट उपलब्ध
- ICTC (एकीकृत परामर्श और परीक्षण केंद्र)
- गोपनीयता आवश्यक

### उपचार
- ART (एंटीरेट्रोवायरल थेरेपी)
- आजीवन उपचार
- NACO के तहत मुफ्त
...
:::tip
**याद रखें:**
1. STIs: बैक्टीरियल (इलाज योग्य) vs वायरल (नियंत्रणीय)
2. सिंड्रोमिक प्रबंधन: लैब के बिना उपचार
3. मूत्रमार्ग स्राव: सेफ्ट्रिएक्सोन + एज़िथ्रोमाइसिन
4. HIV: ART आजीवन, NACO के तहत मुफ्त
5. रोकथाम: ABC (संयम, वफादार, कंडोम)
6. HIV परीक्षण और परामर्श के लिए ICTC
7. गोपनीयता महत्वपूर्ण है
8. साथी सूचना महत्वपूर्ण
:::
`
  }
];
