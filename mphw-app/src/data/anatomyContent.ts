...
|:------|:---------|:---------|
| **Pituitary** | Base of brain | Growth hormone, TSH, ACTH, FSH, LH |
| **Thyroid** | Neck | T3, T4, Calcitonin |
| **Parathyroid** | Behind thyroid | PTH (Parathyroid hormone) |
| **Adrenal** | Above kidneys | Cortisol, Aldosterone, Adrenaline |
| **Pancreas** | Abdomen | Insulin, Glucagon |
| **Gonads** | Pelvis | Testosterone, Estrogen, Progesterone |
...
| Lobe | Hormones | Functions |
|:-----|:---------|:----------|
| **Anterior** | GH, TSH, ACTH, FSH, LH, Prolactin | Growth, metabolism, reproduction |
| **Posterior** | ADH (Vasopressin), Oxytocin | Water balance, labor |

### Key Hormones

| Hormone | Target | Function |
|:--------|:-------|:---------|
| **GH** | All tissues | Growth |
| **TSH** | Thyroid | Stimulates T3/T4 |
...
| **Oxytocin** | Uterus, breast | Labor, milk ejection |
...
| Hormone | Function |
|:--------|:---------|
| **T3 (Triiodothyronine)** | Active form, metabolism |
...
|:---------|:------|:---------|
| **Hyperthyroidism** | Excess T3/T4 | Weight loss, tachycardia, tremor |
| **Hypothyroidism** | Low T3/T4 | Weight gain, fatigue, cold intolerance |
| **Goiter** | Iodine deficiency | Enlarged thyroid |
| **Cretinism** | Congenital hypothyroid | Stunted growth, mental retardation |
...
|:-------|:---------|:----------|
| **Cortex (outer)** | Cortisol, Aldosterone, Androgens | Stress, salt balance, sex |
| **Medulla (inner)** | Adrenaline, Noradrenaline | Fight-or-flight |

### Cortex Zones (GFR)

| Zone | Hormone | Function |
|:-----|:--------|:---------|
| **Glomerulosa** | Aldosterone | Salt retention |
| **Fasciculata** | Cortisol | Stress response |
...
|:----------|:--------|:---------|
| **Alpha (α)** | Glucagon | Raises blood sugar |
| **Beta (β)** | Insulin | Lowers blood sugar |
...
:::success
**Feedback Loop:**
- High blood sugar → Beta cells → Insulin → Sugar enters cells → Blood sugar ↓
- Low blood sugar → Alpha cells → Glucagon → Liver releases glucose → Blood sugar ↑
:::
...
1. Pituitary = Master gland (controls others)

2. Thyroid needs iodine for T3/T4

3. Adrenal cortex: GFR zones

4. Insulin lowers blood sugar (Beta cells)

5. Glucagon raises blood sugar (Alpha cells)

6. ADH = Water retention

7. Oxytocin = Labor + Milk ejection
:::
`,
    contentHi: `
# 🧬 अंतःस्रावी तंत्र
...
:::info
**अंतःस्रावी तंत्र = हार्मोनल संचार प्रणाली**

- ग्रंथियां सीधे रक्त में हार्मोन स्रावित करती हैं
- तंत्रिका तंत्र से धीमा लेकिन लंबे समय तक प्रभाव
- वृद्धि, चयापचय, प्रजनन नियंत्रित करता है
:::
...
| ग्रंथि | स्थान | हार्मोन |
|:-------|:------|:--------|
| **पिट्यूटरी** | मस्तिष्क आधार | GH, TSH, ACTH, FSH, LH |
| **थायरॉइड** | गर्दन | T3, T4, कैल्सीटोनिन |
| **पैराथायरॉइड** | थायरॉइड के पीछे | PTH |
| **एड्रेनल** | गुर्दों के ऊपर | कोर्टिसोल, एड्रेनालिन |
| **अग्न्याशय** | पेट | इंसुलिन, ग्लूकागन |
| **गोनाड** | श्रोणि | टेस्टोस्टेरोन, एस्ट्रोजन |
...
### स्थान
- मस्तिष्क आधार में सेला टर्सिका में
- हाइपोथैलेमस से जुड़ा

### दो खंड

| खंड | हार्मोन | कार्य |
|:----|:--------|:------|
| **अग्र** | GH, TSH, ACTH, FSH, LH, प्रोलैक्टिन | वृद्धि, चयापचय, प्रजनन |
| **पश्च** | ADH, ऑक्सीटोसिन | जल संतुलन, प्रसव |
...
|:--------|:------|:------|
| **GH** | सभी ऊतक | वृद्धि |
| **TSH** | थायरॉइड | T3/T4 उत्तेजना |
| **इंसुलिन** | यकृत, मांसपेशी | रक्त शर्करा कम |
| **ADH** | गुर्दे | जल प्रतिधारण |
| **ऑक्सीटोसिन** | गर्भाशय, स्तन | प्रसव, दूध |
...
### स्थान
- तितली के आकार की
- गर्दन में स्वरयंत्र के नीचे

### हार्मोन

| हार्मोन | कार्य |
|:--------|:------|
| **T3** | सक्रिय रूप, चयापचय |
| **T4** | T3 का अग्रदूत |
| **कैल्सीटोनिन** | रक्त कैल्शियम कम |

### विकार

| विकार | कारण | विशेषताएं |
|:-------|:-----|:---------|
| **हाइपरथायरॉइडिज्म** | अधिक T3/T4 | वजन कम, तेज धड़कन |
| **हाइपोथायरॉइडिज्म** | कम T3/T4 | वजन बढ़ना, थकान |
| **गॉइटर** | आयोडीन की कमी | बढ़ी हुई थायरॉइड |
| **क्रेटिनिज्म** | जन्मजात हाइपोथायरॉइड | बौनापन, मानसिक मंदता |
...
|:-------|:--------|:------|
| **कॉर्टेक्स (बाहरी)** | कोर्टिसोल, एल्डोस्टेरोन | तनाव, नमक संतुलन |
| **मेडुला (भीतरी)** | एड्रेनालिन | लड़ो-या-भागो |

---

## 🍬 अग्न्याशय - दोहरा कार्य

### अंतःस्रावी कार्य (लैंगरहैंस द्वीप)

| कोशिका प्रकार | हार्मोन | कार्य |
|:--------------|:--------|:------|
| **अल्फा (α)** | ग्लूकागन | रक्त शर्करा बढ़ाता है |
| **बीटा (β)** | इंसुलिन | रक्त शर्करा कम करता है |

### रक्त शर्करा नियमन

:::success
**फीडबैक लूप:**
- उच्च रक्त शर्करा → बीटा कोशिकाएं → इंसुलिन → शर्करा ↓
- निम्न रक्त शर्करा → अल्फा कोशिकाएं → ग्लूकागन → शर्करा ↑
:::
...
### वृषण (पुरुष)
- **टेस्टोस्टेरोन:** पुरुष विशेषताएं, शुक्राणु उत्पादन

### अंडाशय (महिला)
- **एस्ट्रोजन:** महिला विशेषताएं, मासिक चक्र
- **प्रोजेस्टेरोन:** गर्भावस्था रखरखाव
...
2. थायरॉइड को T3/T4 के लिए आयोडीन चाहिए

3. इंसुलिन रक्त शर्करा कम करता है (बीटा कोशिकाएं)

4. ग्लूकागन रक्त शर्करा बढ़ाता है (अल्फा कोशिकाएं)

5. ADH = जल प्रतिधारण

6. ऑक्सीटोसिन = प्रसव + दूध निष्कासन
:::
`
  },
  {
    id: 12,
    titleEn: "Lymphatic & Immune System",
    titleHi: "लसीका और प्रतिरक्षा तंत्र",
    contentEn: `
...
:::info
**Lymphatic System = Body's drainage & defense system**

Functions:
1. Return fluid to blood
2. Absorb dietary fats
3. House immune cells
:::
...
| Feature | Description |
|:--------|:------------|
| **Origin** | Tissue fluid that enters lymph vessels |
| **Color** | Clear to yellowish |
| **Composition** | Water, proteins, lymphocytes |
| **Flow** | One-way toward heart |

### Lymph Vessels

| Type | Function |
|:-----|:---------|
| **Lymph capillaries** | Collect tissue fluid |
| **Lymph vessels** | Transport lymph |
| **Lymph ducts** | Return to blood |

### Major Lymph Ducts

| Duct | Drains | Empties Into |
|:-----|:-------|:-------------|
| **Right lymphatic duct** | Right upper body | Right subclavian vein |
| **Thoracic duct** | Rest of body (larger) | Left subclavian vein |
...
| Organ | Function |
|:------|:---------|
| **Bone marrow** | B-cell maturation, all blood cells |
...
|:------|:---------|:---------|
| **Lymph nodes** | Throughout body | Filter lymph |
| **Spleen** | Left upper abdomen | Filter blood |
| **Tonsils** | Throat | First line defense |
| **Appendix** | Right lower abdomen | Gut immunity |
| **Peyer's patches** | Small intestine | Gut immunity |
...
| Location | Area Drained |
|:---------|:-------------|
| **Cervical** | Head and neck |
| **Axillary** | Upper limb, breast |
...
| Function | Description |
|:---------|:------------|
| **Blood filter** | Removes old RBCs |
| **Immune** | Houses lymphocytes |
| **Storage** | Platelets, RBCs |
| **Fetal** | Blood cell production |

### Clinical Note
- Can be ruptured in trauma
- Enlarged in infections (malaria, typhoid)
...
| **Inflammatory response** | Fever, swelling |

### Adaptive Immunity

| Type | Mediators | Function |
|:-----|:----------|:---------|
| **Humoral** | B-cells, antibodies | Against extracellular pathogens |
| **Cell-mediated** | T-cells | Against intracellular pathogens |
...
| Cell Type | % | Function |
|:----------|:--|:---------|
| **Neutrophils** | 60-70% | First responders, bacteria |
| **Lymphocytes** | 20-30% | B & T cells, specific immunity |
| **Monocytes** | 3-8% | Become macrophages |
| **Eosinophils** | 1-4% | Parasites, allergies |
| **Basophils** | <1% | Allergies, histamine |
...
| **T-helper (CD4)** | Coordinate immune response |
| **T-cytotoxic (CD8)** | Kill infected cells |
...
| **IgA** | Mucosal immunity (gut, respiratory) |
...
1. Lymph flows ONE way - toward heart

2. Thoracic duct = larger, drains most body

3. B-cells mature in Bone marrow

4. T-cells mature in Thymus

5. Spleen filters blood, lymph nodes filter lymph

6. IgG = Most common, crosses placenta

7. IgA = Mucosal immunity

8. Neutrophils = Most common WBC
:::
`,
    contentHi: `
# 🛡️ लसीका और प्रतिरक्षा तंत्र

## 📖 अवलोकन

:::info
**लसीका तंत्र = शरीर की निकासी और रक्षा प्रणाली**

कार्य:
1. तरल को रक्त में वापस करना
2. आहार वसा अवशोषित करना
3. प्रतिरक्षा कोशिकाओं को रखना
:::
...
| विशेषता | विवरण |
|:--------|:------|
| **उत्पत्ति** | ऊतक द्रव जो लसीका वाहिकाओं में प्रवेश करता है |
| **रंग** | साफ से पीलापन |
| **संरचना** | पानी, प्रोटीन, लिम्फोसाइट्स |
| **प्रवाह** | हृदय की ओर एक-तरफा |

### प्रमुख लसीका नलिकाएं

| नलिका | निकासी | खाली होती है |
|:------|:-------|:------------|
| **दाहिनी लसीका नलिका** | दाहिना ऊपरी शरीर | दाहिनी सबक्लेवियन शिरा |
| **वक्षीय नलिका** | शेष शरीर (बड़ा) | बाईं सबक्लेवियन शिरा |
...
| अंग | कार्य |
|:----|:------|
| **अस्थि मज्जा** | B-कोशिका परिपक्वता, सभी रक्त कोशिकाएं |
| **थाइमस** | T-कोशिका परिपक्वता |

### द्वितीयक लसीकाभ अंग

| अंग | स्थान | कार्य |
|:----|:------|:------|
| **लसीका ग्रंथियां** | पूरे शरीर में | लसीका छानना |
| **प्लीहा** | बाएं ऊपरी पेट | रक्त छानना |
| **टॉन्सिल** | गला | पहली पंक्ति रक्षा |
...
### संरचना
- बीन के आकार की, 1-25 mm
- समूहों में क्लस्टर

### प्रमुख समूह

| स्थान | निकासी क्षेत्र |
|:------|:-------------|
| **ग्रीवा** | सिर और गर्दन |
| **अक्षीय** | ऊपरी अंग, स्तन |
| **वंक्षण** | निचला अंग, पेरिनियम |

### नैदानिक महत्व

:::warning
**बढ़ी हुई लसीका ग्रंथियां संकेत करती हैं:**
- संक्रमण (सबसे आम)
- कैंसर फैलाव (मेटास्टेसिस)
- लिम्फोमा
- ऑटोइम्यून रोग
:::
...
| कार्य | विवरण |
|:------|:------|
| **रक्त छलनी** | पुरानी RBCs हटाती है |
| **प्रतिरक्षा** | लिम्फोसाइट्स रखती है |
| **भंडारण** | प्लेटलेट्स, RBCs |
| **भ्रूण** | रक्त कोशिका उत्पादन |
...
| प्रकार | विवरण |
|:-------|:------|
| **जन्मजात** | जन्म से उपस्थित, गैर-विशिष्ट |
| **अनुकूली** | अर्जित, विशिष्ट |

### जन्मजात प्रतिरक्षा घटक

| घटक | उदाहरण |
|:----|:-------|
| **भौतिक बाधाएं** | त्वचा, श्लेष्मा |
| **रासायनिक बाधाएं** | पेट का अम्ल, लाइसोजाइम |
| **कोशिकीय** | न्यूट्रोफिल, मैक्रोफेज, NK कोशिकाएं |
| **भड़काऊ प्रतिक्रिया** | बुखार, सूजन |

### अनुकूली प्रतिरक्षा

| प्रकार | मध्यस्थ | कार्य |
|:-------|:--------|:------|
| **हास्य** | B-कोशिकाएं, एंटीबॉडी | बाह्य कोशिकीय रोगजनकों के खिलाफ |
| **कोशिका-मध्यस्थ** | T-कोशिकाएं | अंतःकोशिकीय रोगजनकों के खिलाफ |
...
| कोशिका प्रकार | % | कार्य |
|:--------------|:--|:------|
| **न्यूट्रोफिल** | 60-70% | पहले प्रतिक्रियाकर्ता, बैक्टीरिया |
| **लिम्फोसाइट्स** | 20-30% | B और T कोशिकाएं |
| **मोनोसाइट्स** | 3-8% | मैक्रोफेज बनते हैं |
| **इओसिनोफिल** | 1-4% | परजीवी, एलर्जी |
| **बेसोफिल** | <1% | एलर्जी, हिस्टामाइन |
...
| **T-सहायक (CD4)** | प्रतिरक्षा प्रतिक्रिया समन्वय |
| **T-साइटोटॉक्सिक (CD8)** | संक्रमित कोशिकाओं को मारना |
| **NK कोशिकाएं** | कैंसर/वायरस कोशिकाओं को मारना |
...
| वर्ग | कार्य |
|:-----|:------|
| **IgG** | सबसे आम, प्लेसेंटा पार करता है |
| **IgA** | म्यूकोसल प्रतिरक्षा (आंत, श्वसन) |
| **IgM** | पहली प्रतिक्रिया, पेंटामर |
| **IgE** | एलर्जी, परजीवी |
| **IgD** | B-कोशिका सक्रियण |
...
1. लसीका एक-तरफा बहती है - हृदय की ओर

2. वक्षीय नलिका = बड़ी, अधिकांश शरीर निकालती है

3. B-कोशिकाएं अस्थि मज्जा में परिपक्व

4. T-कोशिकाएं थाइमस में परिपक्व

5. प्लीहा रक्त छानती है, लसीका ग्रंथियां लसीका छानती हैं

6. IgG = सबसे आम, प्लेसेंटा पार

7. IgA = म्यूकोसल प्रतिरक्षा

8. न्यूट्रोफिल = सबसे आम WBC
:::
`
  }
];
