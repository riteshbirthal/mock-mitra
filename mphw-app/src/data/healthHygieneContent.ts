...
:::info
**Healthy Housing = Shelter that promotes physical and mental well-being**

Good housing protects from weather, disease, and provides comfort for healthy living.
:::

---

## 🏗️ Components of Healthy Housing

| Component | Requirements |
|:----------|:-------------|
| **Site** | Dry, elevated, away from stagnant water |
| **Foundation** | Damp-proof, raised from ground |
| **Walls** | Strong, weatherproof, insulated |
| **Roof** | Waterproof, adequate slope |
| **Floor** | Smooth, impervious, easy to clean |
| **Doors/Windows** | Adequate for light and ventilation |
...
| Type | Mechanism |
|:-----|:----------|
| **Natural** | Windows, doors, openings |
| **Artificial** | Fans, exhaust systems |
| **Cross** | Openings on opposite walls |
...
| Space | Ventilation Requirement |
|:------|:-----------------------|
| Living room | 1/10 of floor area as windows |
| Kitchen | Exhaust fan or chimney |
| Bathroom | Adequate ventilation for moisture |
...
### Natural Light
- Windows should be 10-20% of floor area
- Daylight factor minimum 1%

### Artificial Light

| Activity | Lux Required |
|:---------|:-------------|
| General areas | 100-150 lux |
| Reading/Writing | 300-500 lux |
| Kitchen work | 200-300 lux |
...
## 🌡️ Indoor Air Pollution

### Sources

| Source | Pollutants |
|:-------|:-----------|
| **Cooking fuel** | Smoke, CO, particulates |
| **Tobacco** | Secondhand smoke |
| **Dampness** | Mold, allergens |
...
:::tip
**Remember:**
1. Healthy housing: Dry, ventilated, well-lit
2. Windows: 10-20% of floor area
3. Cross ventilation is most effective
4. Overcrowding: <50 sq ft/person
5. Indoor smoke is major health hazard
6. LPG/electricity are clean fuels
7. Dampness causes mold and allergies
:::
`,
    contentHi: `
# 🏠 आवास और वेंटिलेशन
...
:::info
**स्वस्थ आवास = शारीरिक और मानसिक कल्याण को बढ़ावा देने वाला आश्रय**

अच्छा आवास मौसम, बीमारी से बचाता है और स्वस्थ जीवन के लिए आराम प्रदान करता है।
:::

---

## 🏗️ स्वस्थ आवास के घटक

| घटक | आवश्यकताएं |
|:----|:----------|
| **स्थान** | सूखा, ऊंचा, रुके पानी से दूर |
| **नींव** | नमी-प्रूफ, जमीन से ऊंचा |
| **दीवारें** | मजबूत, मौसम-प्रूफ |
| **छत** | जलरोधी, पर्याप्त ढलान |
| **फर्श** | चिकना, अभेद्य, साफ करने में आसान |
| **दरवाजे/खिड़कियां** | प्रकाश और वेंटिलेशन के लिए पर्याप्त |
...
| प्रकार | तंत्र |
|:-------|:-----|
| **प्राकृतिक** | खिड़कियां, दरवाजे, खुलना |
| **कृत्रिम** | पंखे, निकास प्रणाली |
| **क्रॉस** | विपरीत दीवारों पर खुलना |

### वेंटिलेशन का महत्व
- इनडोर वायु प्रदूषक हटाता है
- आर्द्रता नियंत्रित करता है
- वायुजनित संक्रमण कम करता है
- आराम बनाए रखता है

### मानक

| स्थान | वेंटिलेशन आवश्यकता |
|:------|:------------------|
| रहने का कमरा | फर्श क्षेत्र का 1/10 खिड़कियां |
| रसोई | निकास पंखा या चिमनी |
| बाथरूम | नमी के लिए पर्याप्त वेंटिलेशन |
...
### प्राकृतिक प्रकाश
- खिड़कियां फर्श क्षेत्र का 10-20% होनी चाहिए
- दिन का प्रकाश कारक न्यूनतम 1%

### कृत्रिम प्रकाश

| गतिविधि | आवश्यक लक्स |
|:--------|:----------|
| सामान्य क्षेत्र | 100-150 लक्स |
| पढ़ना/लिखना | 300-500 लक्स |
| रसोई कार्य | 200-300 लक्स |
...
### परिभाषा
- प्रति व्यक्ति 50 वर्ग फुट से कम
- प्रति कमरा 2 से अधिक व्यक्ति
...
## 🌡️ इनडोर वायु प्रदूषण

### स्रोत

| स्रोत | प्रदूषक |
|:------|:-------|
| **खाना पकाने का ईंधन** | धुआं, CO, कण |
| **तंबाकू** | सेकंडहैंड धुआं |
| **नमी** | फफूंद, एलर्जन |
...
- आंखों में जलन
- सिरदर्द
- कैंसर का जोखिम (बायोमास से)

### रोकथाम
- स्वच्छ खाना पकाने का ईंधन (LPG) उपयोग करें
- वेंटिलेशन सुधारें
- धुआंरहित चूल्हे उपयोग करें
...
:::tip
**याद रखें:**
1. स्वस्थ आवास: सूखा, हवादार, अच्छी रोशनी वाला
2. खिड़कियां: फर्श क्षेत्र का 10-20%
3. क्रॉस वेंटिलेशन सबसे प्रभावी
4. भीड़भाड़: <50 वर्ग फुट/व्यक्ति
5. इनडोर धुआं प्रमुख स्वास्थ्य खतरा
6. LPG/बिजली स्वच्छ ईंधन हैं
7. नमी फफूंद और एलर्जी का कारण
:::
`
  },
  {
    id: 12,
    titleEn: "School Health & Hygiene",
    titleHi: "स्कूल स्वास्थ्य और स्वच्छता",
    contentEn: `
# 🏫 School Health & Hygiene
...
:::info
**School Health = Health services and education in educational institutions**

Schools provide excellent opportunity to promote health among children, families, and communities.
:::
...
|:----------|:-----------|
| **Health Services** | Screening, first aid, referral |
| **Health Education** | Hygiene, nutrition, safety |
| **Healthy Environment** | WASH facilities, clean premises |
| **Nutrition Services** | Mid-day meal, kitchen gardens |
...
|:------|:-----------------|
| **Height/Weight** | Growth, malnutrition |
| **Vision** | Refractive errors |
| **Hearing** | Hearing impairment |
| **Dental** | Cavities, oral hygiene |
| **Skin** | Scabies, ringworm |
| **Anemia** | Pallor, hemoglobin |

### RBSK in Schools
- Rashtriya Bal Swasthya Karyakram
- Mobile health teams
- Screen for 4Ds: Defects, Deficiencies, Diseases, Developmental delays
...
| Facility | Standard |
|:---------|:---------|
| **Toilets** | 1 per 40 boys, 1 per 25 girls |
| **Urinals** | 1 per 20 boys |
| **Handwashing** | Running water, soap |
| **Drinking water** | Safe, accessible |
...
| Age Group | Topics |
|:----------|:-------|
| **Primary** | Personal hygiene, handwashing, nutrition |
| **Middle** | Puberty, menstrual hygiene, safety |
| **Secondary** | Adolescent health, substance abuse, mental health |
...
- Peer education
- Demonstrations
- Competitions (quiz, poster)

---

## 🍽️ Mid-Day Meal (PM POSHAN)
...
:::tip
**Remember:**
1. School health: Services + Education + Environment + Nutrition
2. RBSK: 4Ds screening in schools
3. Toilet ratio: 1:40 boys, 1:25 girls
4. MDM: 450 kcal primary, 700 kcal upper primary
5. Annual health screening for all students
6. Handwashing with soap is critical
7. Health education topics vary by age
:::
`,
    contentHi: `
...
:::info
**स्कूल स्वास्थ्य = शैक्षिक संस्थानों में स्वास्थ्य सेवाएं और शिक्षा**

स्कूल बच्चों, परिवारों और समुदायों में स्वास्थ्य को बढ़ावा देने का उत्कृष्ट अवसर प्रदान करते हैं।
:::
...
| घटक | गतिविधियां |
|:----|:----------|
| **स्वास्थ्य सेवाएं** | स्क्रीनिंग, प्राथमिक चिकित्सा, रेफरल |
| **स्वास्थ्य शिक्षा** | स्वच्छता, पोषण, सुरक्षा |
| **स्वस्थ वातावरण** | WASH सुविधाएं, स्वच्छ परिसर |
| **पोषण सेवाएं** | मध्याह्न भोजन, किचन गार्डन |

---

## 🩺 स्कूल स्वास्थ्य स्क्रीनिंग

### स्क्रीनिंग अनुसूची

| कक्षा | आवृत्ति |
|:------|:--------|
| नया प्रवेश | प्रवेश पर |
| सभी छात्र | वार्षिक |
...
| जांच | क्या देखें |
|:-----|:---------|
| **ऊंचाई/वजन** | वृद्धि, कुपोषण |
| **दृष्टि** | अपवर्तक त्रुटियां |
| **श्रवण** | श्रवण हानि |
| **दंत** | कैविटी, मौखिक स्वच्छता |
| **त्वचा** | खुजली, दाद |
| **एनीमिया** | पीलापन, हीमोग्लोबिन |

### स्कूलों में RBSK
- राष्ट्रीय बाल स्वास्थ्य कार्यक्रम
- मोबाइल स्वास्थ्य टीमें
- 4D के लिए स्क्रीनिंग: दोष, कमी, रोग, विकासात्मक विलंब
...
| सुविधा | मानक |
|:-------|:------|
| **शौचालय** | 1 प्रति 40 लड़के, 1 प्रति 25 लड़कियां |
| **मूत्रालय** | 1 प्रति 20 लड़के |
| **हाथ धोना** | बहता पानी, साबुन |
| **पीने का पानी** | सुरक्षित, सुलभ |

### छात्रों के लिए मुख्य संदेश
- खाने से पहले हाथ धोएं
- शौचालय ठीक से उपयोग करें
- शौचालय साफ रखें
- सुरक्षित पानी पिएं
- दैनिक व्यक्तिगत स्वच्छता
...
| आयु समूह | विषय |
|:---------|:-----|
| **प्राथमिक** | व्यक्तिगत स्वच्छता, हाथ धोना, पोषण |
| **मध्य** | यौवन, मासिक धर्म स्वच्छता, सुरक्षा |
| **माध्यमिक** | किशोर स्वास्थ्य, मादक पदार्थ, मानसिक स्वास्थ्य |
...
- साथी शिक्षा
- प्रदर्शन
- प्रतियोगिताएं (क्विज, पोस्टर)

---

## 🍽️ मध्याह्न भोजन (PM POSHAN)
...
- कैंची, फोरसेप्स
- ORS पैकेट
- पैरासिटामोल (प्रोटोकॉल के साथ)

### सामान्य आपातकालीन स्थितियां
- कट और घाव
- बेहोशी
- नाक से खून
- कीड़े का काटना
...
:::tip
**याद रखें:**
1. स्कूल स्वास्थ्य: सेवाएं + शिक्षा + वातावरण + पोषण
2. RBSK: स्कूलों में 4D स्क्रीनिंग
3. शौचालय अनुपात: 1:40 लड़के, 1:25 लड़कियां
4. MDM: 450 kcal प्राथमिक, 700 kcal उच्च प्राथमिक
5. सभी छात्रों के लिए वार्षिक स्वास्थ्य स्क्रीनिंग
6. साबुन से हाथ धोना महत्वपूर्ण
7. स्वास्थ्य शिक्षा विषय आयु के अनुसार भिन्न
:::
`
  }
];
