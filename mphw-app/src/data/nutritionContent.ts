...
`
  ...
  {
    id: 11,
    titleEn: "Nutrition Assessment & Surveillance",
    titleHi: "पोषण आकलन और निगरानी",
    contentEn: `
...
:::info
**Nutrition Assessment = Evaluation of nutritional status**

Helps identify malnutrition early for timely intervention.
:::
...
| Measure | Method | Use |
|:--------|:-------|:----|
| **Weight** | Scale | Growth monitoring |
| **Height/Length** | Stadiometer/infantometer | Growth assessment |
| **MUAC** | Tape on mid-arm | Acute malnutrition screening |
| **Head circumference** | Tape | Brain growth (0-2 years) |

### Growth Charts

| Indicator | Definition | Indicates |
|:----------|:-----------|:----------|
| **Weight-for-Age** | Z-score for weight | Underweight |
| **Height-for-Age** | Z-score for height | Stunting (chronic) |
| **Weight-for-Height** | Z-score | Wasting (acute) |
| **BMI-for-Age** | BMI plotted | Overweight/Obesity |

### Z-Score Classification

| Z-Score | Classification |
|:--------|:---------------|
| Above +2 | Overweight/Obese |
| -1 to +2 | Normal |
| -2 to -3 | Moderate malnutrition |
| Below -3 | Severe malnutrition |
...
### Measurement
- Left arm, midpoint between shoulder and elbow
- Use MUAC tape

### Classification (Children 6-59 months)

| MUAC | Classification | Action |
|:-----|:---------------|:-------|
| ≥12.5 cm | Normal | Green |
| 11.5-12.4 cm | MAM | Yellow - Supplementary feeding |
| <11.5 cm | SAM | Red - Urgent referral |
...
| Deficiency | Signs |
|:-----------|:------|
| **Protein-energy** | Edema, muscle wasting |
| **Vitamin A** | Night blindness, Bitot spots |
| **Iron** | Pallor, fatigue |
| **Iodine** | Goiter |
| **Vitamin D** | Rickets, bone deformities |
| **Vitamin B** | Angular stomatitis, glossitis |
...
- Weigh all children <5 years monthly
- Plot on growth chart
- Identify growth faltering early
- Counsel mothers

### Growth Faltering
- No weight gain in 2 consecutive months
- Weight loss
...
:::tip
**Remember:**
1. Weight-for-Age = Underweight indicator
2. Height-for-Age = Stunting (chronic)
3. Weight-for-Height = Wasting (acute)
4. Z-score <-3 = Severe malnutrition
5. MUAC <11.5 cm = SAM (Red zone)
6. MUAC 11.5-12.4 cm = MAM (Yellow zone)
7. Monthly growth monitoring for all <5 years
8. Growth faltering = No gain in 2 months
:::
`,
    contentHi: `
# 📊 पोषण आकलन और निगरानी

## 📖 अवलोकन

:::info
**पोषण आकलन = पोषण स्थिति का मूल्यांकन**

समय पर हस्तक्षेप के लिए कुपोषण की जल्दी पहचान में मदद करता है।
:::
...
| माप | विधि | उपयोग |
|:----|:-----|:------|
| **वजन** | तराजू | वृद्धि निगरानी |
| **ऊंचाई/लंबाई** | स्टेडियोमीटर | वृद्धि आकलन |
| **MUAC** | बांह के मध्य में टेप | तीव्र कुपोषण स्क्रीनिंग |
| **सिर की परिधि** | टेप | मस्तिष्क वृद्धि (0-2 वर्ष) |

### विकास चार्ट

| संकेतक | परिभाषा | इंगित करता है |
|:-------|:--------|:-------------|
| **आयु के लिए वजन** | वजन का Z-स्कोर | कम वजन |
| **आयु के लिए ऊंचाई** | ऊंचाई का Z-स्कोर | बौनापन (दीर्घकालिक) |
| **ऊंचाई के लिए वजन** | Z-स्कोर | क्षीणता (तीव्र) |

### Z-स्कोर वर्गीकरण

| Z-स्कोर | वर्गीकरण |
|:--------|:---------|
| +2 से ऊपर | अधिक वजन/मोटापा |
| -1 से +2 | सामान्य |
| -2 से -3 | मध्यम कुपोषण |
| -3 से नीचे | गंभीर कुपोषण |
...
### माप
- बाईं बांह, कंधे और कोहनी के बीच मध्यबिंदु
- MUAC टेप उपयोग करें

### वर्गीकरण (6-59 महीने के बच्चे)

| MUAC | वर्गीकरण | कार्रवाई |
|:-----|:---------|:--------|
| ≥12.5 सेमी | सामान्य | हरा |
| 11.5-12.4 सेमी | MAM | पीला - पूरक आहार |
| <11.5 सेमी | SAM | लाल - तत्काल रेफरल |

---

## 🔬 कुपोषण के नैदानिक संकेत

| कमी | संकेत |
|:----|:------|
| **प्रोटीन-ऊर्जा** | सूजन, मांसपेशी क्षीणता |
| **विटामिन A** | रतौंधी, बिटोट स्पॉट |
| **आयरन** | पीलापन, थकान |
| **आयोडीन** | गॉइटर |
| **विटामिन D** | रिकेट्स, हड्डी विकृति |

---

## 📈 वृद्धि निगरानी

### मासिक वृद्धि निगरानी
- सभी 5 वर्ष से कम बच्चों का मासिक वजन
- विकास चार्ट पर प्लॉट करें
- वृद्धि गिरावट की जल्दी पहचान
- माताओं को परामर्श

### वृद्धि गिरावट
- लगातार 2 महीने वजन न बढ़ना
- वजन घटना
- तत्काल हस्तक्षेप आवश्यक
...
:::tip
**याद रखें:**
1. आयु के लिए वजन = कम वजन संकेतक
2. आयु के लिए ऊंचाई = बौनापन (दीर्घकालिक)
3. ऊंचाई के लिए वजन = क्षीणता (तीव्र)
4. Z-स्कोर <-3 = गंभीर कुपोषण
5. MUAC <11.5 सेमी = SAM (लाल जोन)
6. MUAC 11.5-12.4 सेमी = MAM (पीला जोन)
7. सभी 5 वर्ष से कम के लिए मासिक वृद्धि निगरानी
8. वृद्धि गिरावट = 2 महीने में कोई वृद्धि नहीं
:::
`
  },
  {
    id: 12,
    titleEn: "Management of Acute Malnutrition",
    titleHi: "तीव्र कुपोषण का प्रबंधन",
    contentEn: `
# 🏥 Management of Acute Malnutrition

## 📖 Classification

| Type | MUAC | Weight-for-Height | Edema |
|:-----|:-----|:------------------|:------|
| **SAM** | <11.5 cm | <-3 SD | +/- |
| **MAM** | 11.5-12.4 cm | -3 to -2 SD | - |
...
| Setting | Criteria | Management |
|:--------|:---------|:-----------|
| **Facility (NRC)** | With complications | Inpatient care |
| **Community (CMAM)** | Without complications | Outpatient with RUTF |
...
|:--------|:------------|
| **RUTF** | Ready-to-Use Therapeutic Food |
| **Energy** | 500 kcal/100g |
| **Dose** | 175-200 kcal/kg/day |
...
| Item | Daily Provision |
|:-----|:----------------|
| THR (Take Home Ration) | From Anganwadi |
| SNP | 800 kcal for SAM, 600 for MAM |

### Key Messages for Caregivers
- Continue breastfeeding
- Give energy-dense foods
- Feed frequently (5-6 times)
- Follow-up monthly
- Complete micronutrient supplementation
...
| Infections treated | Completed course |
...
:::tip
**Remember:**
1. SAM: MUAC <11.5 cm or W/H <-3 SD
2. MAM: MUAC 11.5-12.4 cm or W/H -2 to -3 SD
3. SAM with complications = NRC admission
4. SAM without complications = CMAM with RUTF
5. RUTF: 175-200 kcal/kg/day
6. 10 steps of inpatient SAM management
7. Discharge when >15% weight gain
8. Monthly follow-up after discharge
:::
`,
    contentHi: `
# 🏥 तीव्र कुपोषण का प्रबंधन

## 📖 वर्गीकरण

| प्रकार | MUAC | ऊंचाई के लिए वजन | सूजन |
|:-------|:-----|:----------------|:-----|
| **SAM** | <11.5 सेमी | <-3 SD | +/- |
| **MAM** | 11.5-12.4 सेमी | -3 से -2 SD | - |
...
| सेटिंग | मानदंड | प्रबंधन |
|:-------|:-------|:--------|
| **सुविधा (NRC)** | जटिलताओं के साथ | भर्ती देखभाल |
| **समुदाय (CMAM)** | बिना जटिलताओं | RUTF के साथ बाह्य रोगी |
...
5. संक्रमण का इलाज
6. सूक्ष्म पोषक कमी ठीक करें
7. सावधानीपूर्वक आहार शुरू
8. कैच-अप वृद्धि प्राप्त
9. संवेदी उत्तेजना प्रदान
10. छुट्टी की तैयारी
...
| उत्पाद | विवरण |
|:-------|:------|
| **RUTF** | रेडी-टू-यूज थेराप्यूटिक फूड |
| **ऊर्जा** | 500 kcal/100g |
| **खुराक** | 175-200 kcal/kg/दिन |
...
| आइटम | दैनिक प्रावधान |
|:-----|:--------------|
| THR (घर ले जाने का राशन) | आंगनवाड़ी से |
| SNP | SAM के लिए 800 kcal, MAM के लिए 600 |

### देखभालकर्ताओं के लिए मुख्य संदेश
- स्तनपान जारी रखें
- ऊर्जा-घने खाद्य पदार्थ दें
- बार-बार खिलाएं (5-6 बार)
- मासिक फॉलो-अप
- सूक्ष्म पोषक पूरकता पूर्ण करें

---

## 📋 छुट्टी मानदंड (NRC से)

| मानदंड | लक्ष्य |
|:-------|:------|
| वजन वृद्धि | प्रवेश वजन का >15% |
| कोई सूजन नहीं | 7 दिनों के लिए |
| MUAC | >11.5 सेमी |
| अच्छी तरह खाना | अच्छी भूख |
| संक्रमण उपचार | कोर्स पूरा |
...
:::tip
**याद रखें:**
1. SAM: MUAC <11.5 सेमी या W/H <-3 SD
2. MAM: MUAC 11.5-12.4 सेमी या W/H -2 से -3 SD
3. जटिलताओं के साथ SAM = NRC भर्ती
4. बिना जटिलताओं SAM = RUTF के साथ CMAM
5. RUTF: 175-200 kcal/kg/दिन
6. भर्ती SAM प्रबंधन के 10 चरण
7. >15% वजन वृद्धि पर छुट्टी
8. छुट्टी के बाद मासिक फॉलो-अप
:::
`
  }
];
